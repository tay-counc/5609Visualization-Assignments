...
<p>
  ...
  of the left text panel. The chart now shows the current year's data with comparison 
  to a previous year (5 years earlier) to help track changes in genre popularity over time.
</p>
